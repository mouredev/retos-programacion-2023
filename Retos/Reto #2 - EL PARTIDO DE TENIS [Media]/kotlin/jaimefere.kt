...
private enum class Score {
    ...
    companion object {
        ...
        fun getName(obj: Score): String {
            return when(obj) {
                LOVE_LOVE -> "Love - Love"
                LOVE_FIFTEEN -> "Love - 15"
                LOVE_THIRTY -> "Love - 30"
                LOVE_FORTY -> "Love - 40"
                FIFTEEN_LOVE -> "15 - Love"
                FIFTEEN_FIFTEEN -> "15 - 15"
                FIFTEEN_THIRTY -> "15 - 30"
                FIFTEEN_FORTY -> "15 - 40"
                THIRTY_LOVE -> "30 - Love"
                THIRTY_FIFTEEN -> "30 - 15"
                THIRTY_THIRTY -> "30 - Love"
                THIRTY_FORTY -> "30 - 40"
                FORTY_LOVE -> "40 - Love"
                FORTY_FIFTEEN -> "40 - 15"
                FORTY_THIRTY -> "40 - 30"
...
fun main() {
    playGame(arrayOf(Player.P1, Player.P1, Player.P1, Player.P2, Player.P2, Player.P2, Player.P1, Player.P1))
}