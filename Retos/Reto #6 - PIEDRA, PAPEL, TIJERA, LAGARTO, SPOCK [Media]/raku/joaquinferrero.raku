...
my @valores = ( 0, 2, 1, 2, 1 );		# resultados de ganancias y perdidas
...
sub juego(**@jugadas) {						# el doble '**' evita el "despligue" de las listas
    ...
    for @jugadas -> @jugada {					# para todas las jugadas
