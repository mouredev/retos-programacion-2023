...
public class Main {
    public static void main(String[] args) {
        ...
        public static String toString(char[] lista) { //Devuelve un String de una lista de carácteres
        ...
        public static ArrayList<Integer> posiciones_de_letra_palabra(char a, String palabra) { //Devuelve una lista de enteros que son las posiciones del string donde se encuentra la letra pasada como parámetro
        ...
        public static void jugar_partida(int intentos) { //Partida
